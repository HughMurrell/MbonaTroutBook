...
\htmladdnormallink
{Pierre Olivier}{http://www.pierrecraft.co.za}, Technical (deceased) \\ \\ \\
with a foreward by: \\
\htmladdnormallink
...
It all started one sunny day in late 1969 as Eric MacKenzie was walking close by the Crystal stream 
...
\begin{figure}[H]
  \centering
   \includegraphics[scale = 0.4]{images/Dams.jpg}
  \caption{Five of the Nine Mbona dams as seen from Ian Player's bench at the Mbona saddle.}
   \label{fig:MbonaDams}
\end{figure}
